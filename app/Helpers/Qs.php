...
class Qs
{
 ...
 <div class="alert alert-success alert-bordered">
    ...
    {
        $data = ['name', 'email', 'phone', 'phone2', 'dob', 'gender', 'address', 'medical_info', 'nal_id', 'state_id', 'lga_id'];
    ...
    {
        return "Eagles School Management";
    }
    ...
    public static function getCalenderEvents($date = null)
    {
        if (!$date) {
            $date = date('Y-m-d');
        }
