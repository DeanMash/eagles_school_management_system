...
Route::group(['prefix' => 'payments', 'as' => 'payments.', 'middleware' => ['auth']], function () {
    ...
    Route::get('/invoice/{id}/{year?}', [PaymentController::class, 'invoice'])->name('invoice');
...
Route::group(['prefix' => 'students', 'as' => 'students.', 'middleware' => ['auth']], function () {
    ...
    Route::put('/{id}/update-password', [StudentRecordController::class, 'update_password'])->name('update.password');
    Route::post('/{id}/reset-password-custom', [StudentRecordController::class, 'reset_password_custom'])->name('reset.password.custom');
...
Route::group(['prefix' => 'classes', 'as' => 'classes.', 'middleware' => ['auth']], function () {
    ...
    Route::get('/{class_id}/edit', [App\Http\Controllers\SupportTeam\MyClassController::class, 'edit'])->name('edit');
    Route::put('/{class_id}', [App\Http\Controllers\SupportTeam\MyClassController::class, 'update'])->name('update');
    Route::delete('/{class_id}', [App\Http\Controllers\SupportTeam\MyClassController::class, 'destroy'])->name('destroy');
});
...
Route::group(['prefix' => 'subjects', 'as' => 'subjects.', 'middleware' => ['auth']], function () {
    ...
    Route::get('/{subject_id}/edit', [App\Http\Controllers\SupportTeam\SubjectController::class, 'edit'])->name('edit');
    Route::put('/{subject_id}', [App\Http\Controllers\SupportTeam\SubjectController::class, 'update'])->name('update');
    Route::delete('/{subject_id}', [App\Http\Controllers\SupportTeam\SubjectController::class, 'destroy'])->name('destroy');
});
...
Route::group(['prefix' => 'dorms', 'as' => 'dorms.', 'middleware' => ['auth']], function () {
    ...
    Route::get('/{dorm_id}/edit', [App\Http\Controllers\SupportTeam\DormController::class, 'edit'])->name('edit');
    Route::put('/{dorm_id}', [App\Http\Controllers\SupportTeam\DormController::class, 'update'])->name('update');
    Route::delete('/{dorm_id}', [App\Http\Controllers\SupportTeam\DormController::class, 'destroy'])->name('destroy');
});
...
Route::group(['prefix' => 'sections', 'as' => 'sections.', 'middleware' => ['auth']], function () {
    ...
    Route::get('/{section_id}/edit', [App\Http\Controllers\SupportTeam\SectionController::class, 'edit'])->name('edit');
    Route::put('/{section_id}', [App\Http\Controllers\SupportTeam\SectionController::class, 'update'])->name('update');
    Route::delete('/{section_id}', [App\Http\Controllers\SupportTeam\SectionController::class, 'destroy'])->name('destroy');
});
...
Route::group(['prefix' => 'exams', 'as' => 'exams.', 'middleware' => ['auth']], function () {
    ...
    Route::get('/{exam_id}/edit', [App\Http\Controllers\SupportTeam\ExamController::class, 'edit'])->name('edit');
    Route::put('/{exam_id}', [App\Http\Controllers\SupportTeam\ExamController::class, 'update'])->name('update');
    Route::delete('/{exam_id}', [App\Http\Controllers\SupportTeam\ExamController::class, 'destroy'])->name('destroy');
});
...
Route::group(['prefix' => 'grades', 'as' => 'grades.', 'middleware' => ['auth']], function () {
    ...
    Route::get('/{grade_id}/edit', [App\Http\Controllers\SupportTeam\GradeController::class, 'edit'])->name('edit');
    Route::put('/{grade_id}', [App\Http\Controllers\SupportTeam\GradeController::class, 'update'])->name('update');
    Route::delete('/{grade_id}', [App\Http\Controllers\SupportTeam\GradeController::class, 'destroy'])->name('destroy');
});
