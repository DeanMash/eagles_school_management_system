...
Route::group(['prefix' => 'students', 'as' => 'students.', 'middleware' => ['auth']], function () {
    ...
    // Promotion routes must stay before /{id} so literal URLs are not treated as hashed student IDs.
    ...
    // AJAX/static routes must be declared before the catch-all student profile route.
