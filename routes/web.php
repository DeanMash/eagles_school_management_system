...
Route::middleware(['auth'])->group(function () {
    Route::prefix('timetables')->as('tt.')->group(function () {
        ...
        Route::delete('/time-slots/{id}', [App\Http\Controllers\SupportTeam\TimeTableController::class, 'delete_time_slot'])->middleware('teamSA')->name('time_slots.delete');
    ...
    Route::prefix('timetable-records')->as('ttr.')->group(function () {
        ...
        Route::delete('/{ttr_id}', [App\Http\Controllers\SupportTeam\TimeTableController::class, 'delete_record'])->middleware('teamSA')->name('destroy');
