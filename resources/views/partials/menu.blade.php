    ...
    <div class="sidebar-content">
        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                {{--Timetables - Top Level for Admins--}}
                @if(Qs::userIsTeamSA())
                    <li class="nav-item">
                        <a href="{{ route('tt.index') }}" class="nav-link {{ in_array(Route::currentRouteName(), ['tt.index', 'ttr.edit', 'ttr.show', 'ttr.manage']) ? 'active' : '' }}">
                            <i class="icon-calendar52"></i> <span>Timetables</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('events.index') }}" class="nav-link {{ Route::is('events.*') ? 'active' : '' }}">
                            <i class="icon-calendar5"></i> <span>Events</span>
                        </a>
                    </li>
                @endif

                {{--Academics--}}
                @if(Qs::userIsAcademic() && !Qs::userIsTeamSA())
                    <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['tt.index', 'ttr.edit', 'ttr.show', 'ttr.manage']) ? 'nav-item-expanded nav-item-open' : '' }} ">
                        ...
                        {{--Timetables--}}
                            <li class="nav-item"><a href="{{ route('tt.index') }}" class="nav-link {{ in_array(Route::currentRouteName(), ['tt.index', 'ttr.edit', 'ttr.show', 'ttr.manage']) ? 'active' : '' }}">Timetables</a></li>
                        </ul>
                    </li>
                @endif
                        ...
                        <ul class="nav nav-group-sub" data-submenu-title="Administrative">
                            ...
                            <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['payments.index', 'payments.create', 'payments.edit', 'payments.manage', 'payments.show', 'payments.invoice']) ? 'nav-item-expanded' : '' }}">
                                ...
                                <ul class="nav nav-group-sub">
                                    <li class="nav-item"><a href="{{ route('payments.create') }}" class="nav-link {{ Route::is('payments.create') ? 'active' : '' }}">Set Fees (Create)</a></li>
                                    ...
                                    <li class="nav-item"><a href="{{ route('payments.daily_report') }}" class="nav-link {{ Route::is('payments.daily_report') ? 'active' : '' }}">Daily Report</a></li>
                                </ul>
                ...
                @if(Qs::userIsTeamSA())
                    ...
                    {{--Manage Classrooms (Rooms for Timetable)--}}
                    <li class="nav-item">
                        <a href="{{ route('classrooms.index') }}" class="nav-link {{ in_array(Route::currentRouteName(), ['classrooms.index']) ? 'active' : '' }}"><i class="icon-office"></i> <span>Classrooms</span></a>
                    </li>
                    ...
                    {{--Manage Teachers--}}
                    <li class="nav-item">
                        <a href="{{ route('teachers.index') }}" class="nav-link {{ in_array(Route::currentRouteName(), ['teachers.index','teachers.show','teachers.edit',]) ? 'active' : '' }}"><i class="icon-user-tie"></i> <span>Teachers</span></a>
                    </li>
                @endif
