                        ...
                        <div class="list-icons">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    {{--Edit--}}
                                    <a href="{{ route('tt.time_slots.edit', $tms->id) }}" class="dropdown-item"><i class="icon-pencil"></i> Edit</a>

                                    {{--Delete--}}
                                    @if(Qs::userIsSuperAdmin())
                                        <a id="{{ $tms->id }}" onclick="confirmDelete(this.id)" href="#" class="dropdown-item"><i class="icon-trash"></i> Delete</a>
                                        <form method="post" id="item-delete-{{ $tms->id }}" action="{{ route('tt.time_slots.delete', $tms->id) }}" class="hidden">@csrf @method('delete')</form>
                                    @endif
