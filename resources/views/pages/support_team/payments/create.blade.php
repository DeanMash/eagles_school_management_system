                ...
                <div class="col-md-6">
                    <form class="ajax-store" method="post" action="{{ route('payments.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input name="title" value="{{ old('title') }}" required type="text" class="form-control" placeholder="Eg. Term 1 Fees / Semester 1 2026">
                                <small class="form-text text-muted">Use title to indicate term or semester (e.g. "Term 1 School Fees", "Semester 2 Tuition")</small>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="amount" class="col-lg-3 col-form-label font-weight-semibold">Amount (<del style="text-decoration-style: double">ZWG</del>) <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
