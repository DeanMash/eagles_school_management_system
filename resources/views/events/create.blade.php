            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input name="title" id="title" value="{{ old('title') }}" required type="text" class="form-control" placeholder="Event title">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <textarea name="description" id="description" class="form-control" rows="4" placeholder="Event description">{{ old('description') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input name="event_date" id="event_date" value="{{ old('event_date', date('Y-m-d')) }}" required type="date" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input name="start_time" id="start_time" value="{{ old('start_time') }}" type="time" class="form-control" placeholder="HH:MM">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input name="end_time" id="end_time" value="{{ old('end_time') }}" type="time" class="form-control" placeholder="HH:MM">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input name="venue" id="venue" value="{{ old('venue') }}" type="text" class="form-control" placeholder="e.g. Main Hall">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <select name="event_type" id="event_type" required class="form-control">
                                ...
                                <option value="submission" {{ old('event_type') == 'submission' ? 'selected' : '' }}>Submission</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <div class="form-check">
                                ...
                                <input type="checkbox" name="is_public" id="is_public" value="1" {{ old('is_public', true) ? 'checked' : '' }} class="form-check-input">
                                <label class="form-check-label" for="is_public">Public (visible to all users)</label>
                            </div>
                            <small class="form-text text-muted">Private events are only visible to admins and the creator</small>
                        </div>
                    </div>
                </div>
            </div>
